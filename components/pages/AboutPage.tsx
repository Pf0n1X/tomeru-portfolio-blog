...
export function AboutPage() {
  ...
  return (
    <MainLayout>
      <Box maxW="6xl" mx="auto" px={8} py={24} pt={60} overflow="visible">
            ...
            >
              ...
              >
                ...
                <Box as="span" display={{ base: 'inline', md: 'none' }}>
                  Tap my avatar to see what I'm passionate about! ✨
                </Box>
              </Text>
            </motion.div>
          </Box>
            ...
            >
              <VStack gap={4}>
                ...
                <Text 
                  ...
                  textAlign="center"
                >
                  A passionate software developer who loves building modern, performant web applications with clean, scalable code.
                </Text>
              </VStack>
            </motion.div>
          </Box>
